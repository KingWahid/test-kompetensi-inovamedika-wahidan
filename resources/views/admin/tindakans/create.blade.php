...
@section('header')
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Tindakan</h2>
@endsection
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('admin.tindakans.store') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="biaya" id="biaya" class="mt-1 block w-full border-gray-300 rounded-md" value="{{ old('biaya') }}">
                            @error('biaya')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
